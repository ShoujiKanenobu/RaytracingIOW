...
hittable_list cornell_smoke()
{
    ...
    auto diffu = make_shared<diffuse_light>(color(15, 15, 15));

    world.add(make_shared<yz_rect>(0, 555, 0, 555, 555, green));
    world.add(make_shared<yz_rect>(0, 555, 0, 555, 0, red));
    world.add(make_shared<xz_rect>(213, 343, 227, 332, 554, diffu));
...
hittable_list basketball()
{
    auto basketball_texture = make_shared<image_texture>("BasketballColor.jpg");
    auto basketball_surface = make_shared<lambertian>(basketball_texture);

    auto basketball = make_shared<sphere>(point3(0,0,0), 2, basketball_surface);

    return hittable_list(basketball);
}
...
hittable_list MaterialShowcase()
{
    hittable_list world;
    ...
    world.add(make_shared<sphere>(point3(1.0,0,-1), -0.4, material_right));
...
int main()
{
    ...
    int image_width = 400; //Height calculated after switch statement
